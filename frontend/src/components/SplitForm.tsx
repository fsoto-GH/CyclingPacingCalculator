...
export default function SplitFormComponent({
  ...
  return (
    <div className="split-form">
      <h4>Split {splitIndex + 1}</h4>

      <div className="fields-grid">
        <div className="field">
          <label htmlFor={`${prefix}-distance`}>Distance ({dLabel}) *</label>
          <input
            id={`${prefix}-distance`}
            type="number"
            step="any"
      ...
      {showOptional && (
        <div className="optional-fields fields-grid">
          <div className="field">
            <label htmlFor={`${prefix}-moving-speed`}>Speed ({sLabel})</label>
            <input
          ...
          <>
            <div className="field">
              ...
              <input
                ...
                onChange={(e) => update({ sub_split_distance: e.target.value })}
              />
        ...
        {value.sub_split_mode === "custom" && (
          <div className="field">
            ...
            <input
              ...
              onChange={(e) => update({ sub_split_distances: e.target.value })}
