...
echo "Google (OAuth + Maps/Places/Geocoding)"
ask        GOOGLE_CLIENT_ID     "  GOOGLE_CLIENT_ID" ""
ask_secret GOOGLE_CLIENT_SECRET "  GOOGLE_CLIENT_SECRET" ""
ask_secret GOOGLE_API_KEY "  GOOGLE_API_KEY (optional, IP-restricted, server-side)" ""
ask_secret GOOGLE_BROWSER_API_KEY "  GOOGLE_BROWSER_API_KEY (optional, referrer-restricted, tiles only)" ""
echo ""
